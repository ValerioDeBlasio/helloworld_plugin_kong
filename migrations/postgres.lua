return {
  {
    ...
    up = [[
      ...
      BEGIN
        LOOP
          UPDATE helloworld_metrics SET value = value + v WHERE api_id = a_id AND identifier = i AND period = p AND period_date = p_date;
          IF found then
            RETURN;
          END IF;
          BEGIN
            INSERT INTO helloworld_metrics(api_id, period, period_date, identifier, value) VALUES(a_id, p, p_date, i, v);
            RETURN;
  ...
  },
  {
    ...
    up = [[
      ALTER TABLE helloworld_metrics DROP CONSTRAINT helloworld_metrics_pkey;
      ALTER TABLE helloworld_metrics ALTER COLUMN api_id SET DEFAULT '00000000000000000000000000000000';
      ALTER TABLE helloworld_metrics ADD COLUMN route_id uuid NOT NULL DEFAULT '00000000000000000000000000000000';
      ALTER TABLE helloworld_metrics ADD COLUMN service_id uuid NOT NULL DEFAULT '00000000000000000000000000000000';
      ALTER TABLE helloworld_metrics ADD PRIMARY KEY (api_id, route_id, service_id, identifier, period_date, period);
      ...
      BEGIN
        LOOP
          ...
          END IF;
          BEGIN
            INSERT INTO helloworld_metrics(route_id, service_id, period, period_date, identifier, value)
...
--    up = [[
--      ALTER TABLE helloworld_metrics DROP COLUMN api_id;
--    ]],
--    down = nil,
--  },
}

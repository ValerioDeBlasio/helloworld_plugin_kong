local policies = require "kong.plugins.helloworld.policies"
...
HelloWorldHandler.PRIORITY = 901
HelloWorldHandler.VERSION = "0.1.0"
...
ngx.header["das"] = ngx.ctx
  ...
  if ngx.status == 200 then
    ...
    local usage = ngx.ctx['usage']
    local stop = ngx.ctx['stop']
